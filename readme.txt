...
Contributors: Zack The Worker
Tags: custom post type, post type, manage post type
Requires at least: 5.8
Tested up to: 6.6.2
Stable tag: 1.1.0
License: GPLv2 or later

A custom WordPress plugin that allows you to modify the `post_type` of selected posts directly from the post list page.
